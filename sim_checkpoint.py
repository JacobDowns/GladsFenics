...
### Start the model from some checkpoint files

phi_init = Function(V_cg)
File("checkpoint/phi_380.xml") >> phi_init

# Initial sheet height
h0 = Function(V_cg)
File("checkpoint/h_380.xml") >> h0

# Initial channel areas
S0 = Function(V_cr)
File("checkpoint/S_380.xml") >> S0
...
while ode_solver.t <= T :     
  ...
  if i % 1 == 0:
    ...
    cr_tools.copy_cr_to_facet(N_e, N_f)
    out_N_e << N_f
